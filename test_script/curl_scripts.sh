...
curl -k --request POST --user haksoo:haksoorocks! --data-binary @acc_data --header "Content-type:application/octet-stream" "https://localhost:8443/sensorsafe/api/streams/test.csv"
