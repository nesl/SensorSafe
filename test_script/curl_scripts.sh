...
#curl -k --request POST --user haksoo:haksoorocks! --data-binary @acc_data --header "Content-type:application/octet-stream" "https://128.97.93.251:8443/api/streams/test.csv"
